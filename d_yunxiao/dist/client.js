...
var CSS = [
  // 设计变量：浅色为默认，深色跟随系统；线宽统一 1px，激活态用低透明度色衬底。
  ":root{color-scheme:light;--dyx-bg:#f4f6fa;--dyx-panel:#fff;--dyx-panel2:#f5f7fa;--dyx-field:#fff;--dyx-hover:#eef1f6;--dyx-tag:#edf0f5;--dyx-text:#1e2635;--dyx-muted:#68748f;--dyx-line:#e5e9f0;--dyx-line-strong:#ccd4e0;--dyx-brand:#2f6bed;--dyx-brand-solid:#2f6bed;--dyx-brand-weak:rgba(47,107,237,.11);--dyx-danger:#d92d20;--dyx-danger-weak:rgba(217,45,32,.08);--dyx-ok:#067647;--dyx-ok-weak:rgba(23,177,90,.13);--dyx-warn:#b54708;--dyx-warn-weak:rgba(247,144,9,.14);--dyx-status-pending:#9a5b00;--dyx-status-pending-bg:rgba(240,173,78,.16);--dyx-status-pending-line:rgba(154,91,0,.3);--dyx-status-processing:#1d5fd1;--dyx-status-processing-bg:rgba(47,107,237,.08);--dyx-status-processing-line:rgba(29,95,209,.32);--dyx-status-reopened:#b04a7e;--dyx-status-reopened-bg:rgba(214,79,145,.1);--dyx-status-reopened-line:rgba(176,74,126,.3);--dyx-shadow:0 20px 55px rgba(15,23,42,.2);--dyx-shadow-sm:0 1px 2px rgba(16,24,40,.05)}",
  "@media(prefers-color-scheme:dark){:root{color-scheme:dark;--dyx-bg:#10151d;--dyx-panel:#171e29;--dyx-panel2:#1c2432;--dyx-field:#121826;--dyx-hover:#222c3c;--dyx-tag:#222c3c;--dyx-text:#e7ecf4;--dyx-muted:#8d9cb3;--dyx-line:#2a3442;--dyx-line-strong:#3c4859;--dyx-brand:#7fa7ff;--dyx-brand-solid:#3168d9;--dyx-brand-weak:rgba(127,167,255,.14);--dyx-danger:#f2796b;--dyx-danger-weak:rgba(242,121,107,.12);--dyx-ok:#4cc38a;--dyx-ok-weak:rgba(76,195,138,.14);--dyx-warn:#e8a33d;--dyx-warn-weak:rgba(232,163,61,.15);--dyx-status-pending:#e5b25d;--dyx-status-pending-bg:rgba(229,178,93,.11);--dyx-status-pending-line:rgba(229,178,93,.28);--dyx-status-processing:#8fb5ff;--dyx-status-processing-bg:rgba(143,181,255,.11);--dyx-status-processing-line:rgba(143,181,255,.3);--dyx-status-reopened:#ef9abd;--dyx-status-reopened-bg:rgba(239,154,189,.11);--dyx-status-reopened-line:rgba(239,154,189,.3);--dyx-shadow:0 22px 60px rgba(0,0,0,.55);--dyx-shadow-sm:0 1px 2px rgba(0,0,0,.25)}}",
  ".dyx-root,.dyx-root *{box-sizing:border-box}",
  ".dyx-slot-host{width:100%;height:100%;min-height:0}",
  ".dyx-right-panel{position:absolute;inset:0 0 0 auto;width:var(--dyx-workspace-width,480px);min-width:0;overflow:hidden;pointer-events:auto;background:var(--dyx-bg);box-shadow:-8px 0 24px rgba(15,23,42,.1)}",
  ...
  ".dyx-shell{position:absolute;inset:0;display:grid;grid-template-rows:auto minmax(0,1fr);overflow:hidden;border-left:1px solid var(--dyx-line);background:var(--dyx-bg)}",
  ".dyx-hidden{display:none!important}",
  ".dyx-head{display:flex;align-items:center;gap:10px;min-height:50px;padding:8px 12px 8px 16px;border-bottom:1px solid var(--dyx-line);background:var(--dyx-panel)}",
  ".dyx-logo{width:30px;height:30px;flex:none;display:grid;place-items:center;border-radius:8px;color:#fff;background:linear-gradient(135deg,#4c8dff,#2f6bed);font-size:14px;font-weight:700}",
  ".dyx-head-copy{min-width:0;flex:1}.dyx-head-copy strong{display:block;font-size:14px;font-weight:650;line-height:1.35}.dyx-head-copy span{display:block;color:var(--dyx-muted);font-size:12px;line-height:1.4;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
  ".dyx-body{min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr)}",
  // 页签：分段控件，选中项为浮起的面板小块，不再使用描边盒子。
  ".dyx-nav{margin:12px 16px 0;padding:3px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:2px;border:1px solid var(--dyx-line);border-radius:9px;background:var(--dyx-panel2)}",
  ".dyx-nav button{width:100%;min-height:30px;padding:4px 8px;display:flex;align-items:center;justify-content:center;border:1px solid transparent;border-radius:7px;color:var(--dyx-muted);background:transparent;cursor:pointer;text-align:center;font:inherit;font-size:13px;font-weight:500;transition:color .15s,background .15s}",
  ".dyx-nav button:hover{color:var(--dyx-text)}.dyx-nav button.active{color:var(--dyx-text);border-color:var(--dyx-line);background:var(--dyx-panel);font-weight:600;box-shadow:var(--dyx-shadow-sm)}",
  ".dyx-main{min-width:0;overflow:auto;padding:14px 16px 20px;scrollbar-width:thin;scrollbar-color:var(--dyx-line-strong) transparent}",
  ".dyx-section{max-width:100%;margin:0 auto}.dyx-title{margin:2px 0 12px;display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.dyx-title h2{margin:0;font-size:16px;font-weight:650}.dyx-title p{margin:3px 0 0;color:var(--dyx-muted);font-size:12px}",
  ".dyx-card{padding:14px 16px 16px;border:1px solid var(--dyx-line);border-radius:10px;background:var(--dyx-panel);box-shadow:var(--dyx-shadow-sm)}.dyx-card+.dyx-card{margin-top:12px}",
  ".dyx-card-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:12px}.dyx-card-head h3{margin:0;font-size:14px;font-weight:600}.dyx-card-head small{color:var(--dyx-muted);font-size:12px}.dyx-card-title{display:flex;align-items:center;gap:7px;min-width:0}",
  ".dyx-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:10px}.dyx-account{padding:12px;border:1px solid var(--dyx-line);border-radius:9px;background:var(--dyx-panel);transition:border-color .15s,background .15s}.dyx-account.active{border-color:color-mix(in srgb,var(--dyx-brand) 45%,var(--dyx-line));background:color-mix(in srgb,var(--dyx-brand) 4%,var(--dyx-panel))}",
  ".dyx-account-top{display:flex;gap:10px;align-items:center;cursor:pointer}.dyx-avatar{width:34px;height:34px;display:grid;place-items:center;flex:none;border-radius:8px;color:#fff;background:linear-gradient(135deg,#4c8dff,#2f6bed);font-size:14px;font-weight:700}.dyx-grow{min-width:0;flex:1}.dyx-grow strong,.dyx-grow small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.dyx-grow strong{font-size:13.5px;font-weight:600}.dyx-grow small{color:var(--dyx-muted);font-size:12px}",
  ".dyx-actions{display:flex;align-items:center;gap:6px;flex-wrap:wrap}.dyx-account-top .dyx-actions{flex:none}",
  ".dyx-btn{min-height:30px;padding:5px 12px;border:1px solid var(--dyx-line-strong);border-radius:8px;color:var(--dyx-text);background:var(--dyx-panel);cursor:pointer;font:inherit;font-size:13px;white-space:nowrap;transition:background .15s,border-color .15s,color .15s}.dyx-btn:hover{background:var(--dyx-hover)}.dyx-btn.primary{border-color:transparent;color:#fff;background:var(--dyx-brand-solid)}.dyx-btn.primary:hover{background:color-mix(in srgb,var(--dyx-brand-solid) 86%,#fff)}.dyx-btn.danger{color:var(--dyx-danger)}.dyx-btn.danger:hover{border-color:color-mix(in srgb,var(--dyx-danger) 38%,transparent);background:var(--dyx-danger-weak)}.dyx-btn:disabled{opacity:.5;cursor:not-allowed}",
  ".dyx-btn-sm{min-height:26px;padding:3px 9px;font-size:12px;border-radius:7px}",
  // 关闭按钮与 .dyx-btn 组合使用，必须排在其后才能覆盖边框与内边距。
  ".dyx-close{width:30px;height:30px;min-height:30px;padding:0;border:1px solid transparent;border-radius:8px;color:var(--dyx-muted);background:transparent;cursor:pointer;font-size:17px;line-height:1}.dyx-close:hover{color:var(--dyx-text);background:var(--dyx-hover)}",
  ".dyx-icon-btn{width:28px;min-height:28px;padding:0;border:1px solid transparent;border-radius:7px;color:var(--dyx-muted);background:transparent;cursor:pointer;font:inherit;font-size:14px;line-height:1}.dyx-icon-btn:hover{color:var(--dyx-brand);background:var(--dyx-brand-weak)}.dyx-icon-btn:disabled{opacity:.45;cursor:not-allowed}",
  ".dyx-field{display:grid;gap:5px}.dyx-field label{color:var(--dyx-muted);font-size:12px}.dyx-input,.dyx-select,.dyx-textarea{width:100%;min-height:32px;padding:5px 10px;border:1px solid var(--dyx-line-strong);border-radius:8px;color:var(--dyx-text);background:var(--dyx-field);outline:0;font:inherit;font-size:13px;transition:border-color .15s,box-shadow .15s}.dyx-input:focus,.dyx-select:focus,.dyx-textarea:focus{border-color:var(--dyx-brand);box-shadow:0 0 0 3px var(--dyx-brand-weak)}.dyx-input::placeholder,.dyx-textarea::placeholder{color:color-mix(in srgb,var(--dyx-muted) 72%,transparent)}.dyx-textarea{min-height:84px;resize:vertical;line-height:1.6}.dyx-select[multiple]{min-height:112px;padding:5px}.dyx-select[multiple] option{padding:6px 8px;border-radius:5px}",
  ".dyx-project-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center}.dyx-current{margin-top:12px;padding:9px 12px;border-radius:8px;color:var(--dyx-muted);background:var(--dyx-panel2);font-size:12.5px}.dyx-current strong{color:var(--dyx-text);font-weight:600}",
  ...
  ".dyx-empty{padding:36px 16px;text-align:center;color:var(--dyx-muted);font-size:13px}.dyx-empty strong{display:block;margin-bottom:4px;color:var(--dyx-text);font-size:14px;font-weight:600}",
  ".dyx-attachments{display:grid;gap:6px}.dyx-attachment{display:flex;align-items:center;gap:8px;min-width:0;padding:6px 8px;border:1px solid var(--dyx-line);border-radius:8px;background:var(--dyx-panel2)}.dyx-attachment-name{flex:1 1 auto;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.dyx-attachment-size{flex:none;color:var(--dyx-muted);font-size:12px}.dyx-attachment .dyx-btn{flex:none}",
  ...
  ".dyx-modal-head,.dyx-modal-foot{padding:12px 16px;display:flex;align-items:center;justify-content:space-between;gap:12px}.dyx-modal-head{border-bottom:1px solid var(--dyx-line)}.dyx-modal-head h3{margin:0;font-size:15px;font-weight:650}.dyx-modal-foot{border-top:1px solid var(--dyx-line);justify-content:flex-end}.dyx-modal-body{padding:16px;overflow:auto;scrollbar-width:thin;scrollbar-color:var(--dyx-line-strong) transparent}.dyx-form{display:grid;gap:12px}.dyx-two{display:grid;grid-template-columns:1fr 1fr;gap:10px}",
  ".dyx-detail-title{display:flex;align-items:flex-start;gap:10px;margin-bottom:12px}.dyx-detail-title h2{margin:0;font-size:16px;font-weight:650;line-height:1.45}.dyx-meta{display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:8px;margin:12px 0}.dyx-meta div{padding:8px 10px;border-radius:8px;background:var(--dyx-panel2);font-size:13px}.dyx-meta small{display:block;margin-bottom:1px;color:var(--dyx-muted);font-size:11.5px}",
  ".dyx-rich{line-height:1.75;overflow-wrap:anywhere;font-size:13.5px}.dyx-rich img{max-width:100%;height:auto;border-radius:8px}.dyx-rich pre,.dyx-log{overflow:auto;padding:12px;border:1px solid var(--dyx-line);border-radius:9px;color:#c9d8f0;background:#0d1424;font:12px/1.65 Consolas,Menlo,Monaco,monospace;white-space:pre-wrap;scrollbar-width:thin;scrollbar-color:#3c4859 transparent}.dyx-rich table{border-collapse:collapse}.dyx-rich td,.dyx-rich th{border:1px solid var(--dyx-line-strong);padding:5px 8px}",
  ".dyx-comment-compose{margin-bottom:12px;padding:12px;border:1px solid var(--dyx-line);border-radius:9px;background:var(--dyx-panel2)}.dyx-comment-compose .dyx-textarea{min-height:92px;background:var(--dyx-field)}.dyx-comment-compose-actions{margin-top:8px;display:flex;align-items:center;justify-content:space-between;gap:10px}.dyx-comment-compose-actions span{color:var(--dyx-muted);font-size:11.5px}.dyx-comments{display:grid;gap:8px}.dyx-comment{padding:10px 12px;border:1px solid var(--dyx-line);border-radius:9px}.dyx-comment-head{display:flex;justify-content:space-between;margin-bottom:6px;color:var(--dyx-muted);font-size:12px}.dyx-comment-head strong{color:var(--dyx-text);font-weight:600}",
  ".dyx-status-row{display:flex;align-items:end;gap:8px}.dyx-status-row .dyx-field{min-width:170px;flex:1}.dyx-note{padding:9px 12px;border-radius:8px;color:var(--dyx-warn);background:var(--dyx-warn-weak);font-size:12.5px}",
  ".dyx-stage{margin:6px 0;padding:8px 12px;display:grid;grid-template-columns:10px 1fr auto;align-items:center;gap:10px;border:1px solid var(--dyx-line);border-radius:8px}.dyx-dot{width:8px;height:8px;border-radius:50%;background:#8a97ab}.dyx-dot.SUCCESS{background:#22a06b}.dyx-dot.RUNNING{background:#e8a33d}.dyx-dot.FAIL,.dyx-dot.FAILED{background:#e5484d}",
  ".dyx-record-list{display:grid;grid-template-columns:minmax(0,1fr);gap:8px}.dyx-record{padding:11px 13px;border:1px solid var(--dyx-line);border-radius:9px;background:var(--dyx-panel2)}.dyx-record.dyx-record-status-pending{border-color:var(--dyx-status-pending-line);background:color-mix(in srgb,var(--dyx-status-pending) 5%,var(--dyx-panel2))}.dyx-record.dyx-record-status-processing{border-color:var(--dyx-status-processing-line);background:color-mix(in srgb,var(--dyx-status-processing) 5%,var(--dyx-panel2))}.dyx-record.dyx-record-status-reopened{border-color:var(--dyx-status-reopened-line);background:color-mix(in srgb,var(--dyx-status-reopened) 5%,var(--dyx-panel2))}.dyx-record-head,.dyx-record-foot{display:flex;align-items:center;justify-content:space-between;gap:9px}.dyx-record-title{margin:8px 0;color:var(--dyx-text);font-size:13.5px;font-weight:600;line-height:1.5}.dyx-record-meta{display:flex;align-items:center;gap:6px;flex-wrap:wrap;color:var(--dyx-muted);font-size:12px}.dyx-record-foot{margin-top:9px;padding-top:9px;border-top:1px solid var(--dyx-line)}",
  ...
  ".dyx-inline-status{width:150px;min-height:28px;padding:3px 26px 3px 9px;border-radius:7px;font-size:12px}.dyx-status-pending{color:var(--dyx-status-pending);border-color:var(--dyx-status-pending-line);background:var(--dyx-status-pending-bg)}.dyx-status-processing{color:var(--dyx-status-processing);border-color:var(--dyx-status-processing-line);background:var(--dyx-status-processing-bg)}.dyx-status-reopened{color:var(--dyx-status-reopened);border-color:var(--dyx-status-reopened-line);background:var(--dyx-status-reopened-bg)}",
  // 提示条不拦截点击（pointer-events:none），并放在左下角，避免盖住弹窗右上角的 × 和底部“关闭”按钮。
  ".dyx-toast-wrap{position:absolute;z-index:60;left:12px;bottom:12px;display:grid;gap:8px;pointer-events:none}.dyx-toast{max-width:340px;padding:9px 13px;border:1px solid var(--dyx-line);border-radius:9px;background:var(--dyx-panel);box-shadow:var(--dyx-shadow);font-size:13px}.dyx-toast.error{color:var(--dyx-danger);border-color:color-mix(in srgb,var(--dyx-danger) 32%,transparent)}",
  ".dyx-global-notice{position:fixed;z-index:2147483000;right:22px;top:22px;width:min(380px,calc(100vw - 44px));padding:13px 15px;border:1px solid var(--dyx-line);border-radius:11px;color:var(--dyx-text);background:var(--dyx-panel);box-shadow:var(--dyx-shadow);font:13.5px/1.55 -apple-system,BlinkMacSystemFont,'Segoe UI','PingFang SC','Microsoft YaHei',sans-serif;animation:dyx-slide-in .18s ease-out}.dyx-global-notice strong{display:block;margin-bottom:2px;font-size:14px;font-weight:650}.dyx-global-notice span{display:block;color:var(--dyx-muted);font-size:12.5px}.dyx-global-notice-actions{margin-top:10px;display:flex;justify-content:flex-end;gap:8px}.dyx-global-notice-actions button{min-height:28px;padding:4px 11px;border:1px solid var(--dyx-line-strong);border-radius:7px;color:var(--dyx-text);background:var(--dyx-panel);cursor:pointer;font:inherit;font-size:12.5px}.dyx-global-notice-actions button:hover{background:var(--dyx-hover)}.dyx-global-notice-actions button.primary{border-color:transparent;color:#fff;background:var(--dyx-brand-solid)}",
  ".dyx-loading{opacity:.6;pointer-events:none}.dyx-stale{margin-bottom:10px;padding:8px 11px;border-radius:8px;color:var(--dyx-warn);background:var(--dyx-warn-weak);font-size:12.5px}",
  "@container(max-width:430px){.dyx-main{padding:12px}.dyx-notify-grid,.dyx-project-row{grid-template-columns:1fr}.dyx-defect-filters .dyx-field{width:140px}.dyx-pipeline-filters .dyx-field{width:150px}.dyx-defect-row .dyx-inline-status{width:88px}.dyx-defect-row-assignee{max-width:96px}.dyx-title{display:block}.dyx-title>.dyx-btn,.dyx-title>.dyx-actions{margin-top:8px}.dyx-modal-body{padding:12px}.dyx-head{padding:8px 8px 8px 12px}.dyx-nav{margin:10px 12px 0}.dyx-status-row{align-items:stretch;flex-direction:column}.dyx-status-row .dyx-field{min-width:0}}",
